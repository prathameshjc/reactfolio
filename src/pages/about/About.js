    ...
    return (
        <div id="about">
            <div className="about">
                ...
                <h1 className="pt-3 text-center pb-3 font-details ">About Me</h1>
                <Container>
                    <Row className="pt-3 pb-5 align-items-center">
                        {/* Profile picture */}
                        <Col xs={12} md={6}>
                            <Row className="justify-content-center mb-2 mr-2">
                                <Image className="profile justify-content-end" src={profile} alt="prathamesh profile image" thumbnail />
                            </Row>
                        </Col>
                        {/* description */}
                        <Col xs={12} md={6}>
